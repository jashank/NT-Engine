...
App* App::CreateApp( const std::string& title, 
	...
	if(  m_instance == 0 ) {
		DEBUG_STATEMENT( std::cout << "Creating App...\n-->Title: " << title << std::endl; )
		DEBUG_STATEMENT( std::cout << "-->Width: " << width << std::endl; )
		DEBUG_STATEMENT( std::cout << "-->Height: " << height << std::endl; )
		DEBUG_STATEMENT( std::cout << "-->Framerate: " << framerate << std::endl; )
